 ...
 * @dev Gas-optimized smart contract for processing USDT payments on Ethereum Mainnet
 * @notice This contract uses approve + transferFrom pattern for secure payments
 * Uses real Ethereum USDT: 0xdAC17F958D2ee523a2206206994597C13D831ec7
 *
 * Key optimizations:
 ...
 *
 * @notice CRITICAL: Ethereum USDT has 6 decimals, not 18!
 */
...
contract PaymentProcessorOptimized {
     ...
     * @param _amount Amount of USDT to pay (in wei, 6 decimals for Ethereum USDT)

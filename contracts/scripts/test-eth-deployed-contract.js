...
async function main() {
  console.log("🧪 Testing deployed SafePing contract on Ethereum Mainnet...");

  // Contract address from your deployment
  const CONTRACT_ADDRESS = "0x24f2a8660d49713907d773fdf9157d251ba9c1f5";
  ...
  try {
    ...
    console.log(
      `✅ Deployer allowance: ${ethers.formatUnits(deployerAllowance, 6)} USDT`
    );
    console.log(
    ...
    console.log("\n🔗 View on Etherscan (USDT):");
    console.log(`https://etherscan.io/address/${USDT_CONTRACT}`);
  } catch (error) {
